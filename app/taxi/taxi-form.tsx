  ...
  return (
    <div className="bg-white rounded-2xl border border-border overflow-hidden">
      <div className="px-7 py-5 border-b border-border">
        <h2 className="font-bold text-foreground text-lg">Book a Taxi</h2>
      ...
      <form action={action} className="p-7 space-y-5">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
          <div className="sm:col-span-2">
            ...
            <input
              ...
              type="text"
              required
              placeholder="e.g. Block 123, Geylang Rd, Singapore"
          ...
          <div className="sm:col-span-2">
            ...
            <input
              ...
              type="text"
              required
              placeholder="e.g. Changi Airport Terminal 2"
              className="w-full px-3.5 py-2.5 rounded-xl border border-border text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-brand/30 focus:border-brand text-sm transition-colors"
            />
          </div>
          ...
          <div className="sm:col-span-2">
            ...
            <textarea
              name="notes"
              rows={3}
              placeholder="Special requests, luggage info, medical needs, etc."
        ...
        >
          {pending ? "Submitting Request…" : "Submit Taxi Request"}
        </button>
      </form>
    </div>
  );
