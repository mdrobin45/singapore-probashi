    ...
    <div className="min-h-screen bg-muted">
      ...
      <div className="bg-white border-b border-border">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
          ...
          <h1 className="text-3xl font-bold text-foreground">Community Taxi Service</h1>
          <p className="text-muted-foreground mt-2 max-w-xl">Book reliable, community-vetted taxis anywhere in Singapore. Airport transfers, hospital runs, day trips — we&apos;ve got you covered.</p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          {/* Left: info + vehicle types */}
          <div className="lg:col-span-1 space-y-5">
            {/* Vehicle types */}
            <div className="bg-white rounded-2xl border border-border p-6">
              <h2 className="font-semibold text-foreground mb-4">Available Vehicles</h2>
              <div className="space-y-4">
                {VEHICLE_TYPES.map((v) => (
                  <div key={v.type} className="flex items-start gap-3">
                    <span className="text-2xl">{v.icon}</span>
                    <div>
                      <p className="font-medium text-foreground text-sm">{v.type}</p>
                      <p className="text-xs text-brand font-semibold">{v.capacity}</p>
            ...
            <div className="bg-brand-50 rounded-2xl border border-brand-100 p-5">
              <p className="text-sm font-semibold text-brand mb-2">Need urgent booking?</p>
              <p className="text-xs text-muted-foreground mb-3">Contact us directly on WhatsApp for immediate assistance.</p>
              <a
          ...
          <div className="lg:col-span-2">
            {session ? (
              ...
              <div className="bg-white rounded-2xl border border-border p-10 text-center">
                ...
                <h2 className="font-bold text-foreground text-xl mb-2">Login to Book a Taxi</h2>
                <p className="text-muted-foreground text-sm mb-6">You need to be logged in to submit a taxi request.</p>
