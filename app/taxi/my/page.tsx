    ...
    <div className="min-h-screen bg-muted">
      <div className="bg-white border-b border-border">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8">
          ...
          <h1 className="text-2xl font-bold text-foreground">My Taxi Requests</h1>
          <p className="text-sm text-muted-foreground mt-1">Track the status, assigned driver, and price for your bookings.</p>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8 space-y-4">
        {requests.length === 0 ? (
          <div className="text-center py-20">
            ...
            <p className="text-muted-foreground text-sm mb-6">Book a taxi and track its status here.</p>
            <Link
              href="/taxi"
