    ...
    <div className="min-h-screen bg-muted">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
              ...
              <div className="flex flex-wrap gap-2 mt-3">
                ...
                {user.isVerified ? (
                  <span className="text-xs font-semibold text-green-700 bg-green-50 border border-green-200 px-3 py-1 rounded-full flex items-center gap-1">
                    <span className="w-1.5 h-1.5 rounded-full bg-green-500 inline-block" /> {t("verified")}
                  </span>
                ) : (
        ...
        <div className="grid grid-cols-3 gap-4 mb-5">
          {[
            { label: t("shareProjects"), value: user._count.ownedShares, href: "/shares" },
            { label: t("lostFoundPosts"), value: user._count.lostFoundPosts, href: "/lost-found" },
            { label: t("blogPosts"), value: user._count.blogPosts, href: "/blog" },
          ].map((s) => (
        ...
        <div className="bg-white rounded-xl border border-border p-5">
          <h2 className="font-semibold text-foreground mb-4 text-sm">{t("quickActions")}</h2>
