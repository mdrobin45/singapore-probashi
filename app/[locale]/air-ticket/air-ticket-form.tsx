      ...
      <form action={action} className="p-7 space-y-5">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
          <div className="sm:col-span-2">
            <label className="block text-sm font-medium text-foreground mb-1.5">{t("origin")}</label>
            <input
              name="origin"
              type="text"
              required
          ...
          <div className="sm:col-span-2">
            <label className="block text-sm font-medium text-foreground mb-1.5">{t("destination")}</label>
            <input
              name="destination"
              type="text"
              required
          ...
          <div>
            <label className="block text-sm font-medium text-foreground mb-1.5">{t("departDate")}</label>
            <input
              name="departDate"
              type="date"
              required
          ...
          <div>
            <label className="block text-sm font-medium text-foreground mb-1.5">
              {t("returnDate")} <span className="text-muted-foreground font-normal">({t("returnDateOptional")})</span>
            </label>
            <input
              name="returnDate"
              type="date"
