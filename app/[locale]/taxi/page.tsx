...
export default async function TaxiPage() {
  ...
  const VEHICLE_TYPES = [
    { type: t("vehicleSedan"), capacity: t("vehicleSedanCapacity"), desc: t("vehicleSedanDesc"), icon: "🚗" },
    { type: t("vehicleMPV"), capacity: t("vehicleMPVCapacity"), desc: t("vehicleMPVDesc"), icon: "🚐" },
    { type: t("vehicleVan"), capacity: t("vehicleVanCapacity"), desc: t("vehicleVanDesc"), icon: "🚌" },
  ];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1 space-y-5">
            ...
            <div className="bg-white rounded-2xl border border-border p-6">
              <h2 className="font-semibold text-foreground mb-4">{t("availableVehicles")}</h2>
